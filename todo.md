...
### 任务描述
完善Web界面的登录鉴权功能和系统安全设置,确保暴露到公网后的安全性

### Phase 1: 设计安全架构和数据库schema
- [x] 设计用户认证架构(本地用户表 vs Manus OAuth)
- [x] 扩展数据库schema添加本地用户表
- [x] 设计SSH访问控制配置表
- [x] 设计会话管理机制
...
### Phase 6: 创建初始用户和登录界面
- [x] 创建数据库初始化脚本
- [x] 创建默认用户(URouterOS/password)
- [x] 创建登录页面UI
- [x] 实现登录表单验证
- [ ] 集成到路由系统

### Phase 7: 测试和保存checkpoint
- [ ] 测试登录/注销流程
- [ ] 测试用户管理功能
- [ ] 测试SSH配置功能
- [ ] 测试会话超时
